...
class Custom:
    ...
    def Start(self):
        ...
        self.imuReadThreadPtr = RecurrentThread(
            interval=0.002, target=self.IMUStateRead, name="readimu"
        )
        self.imuReadThreadPtr.Start()
    ...
    def IMUStateRead(self):
        # print("reading IMU")
        print("IMU state: ", self.low_state)
